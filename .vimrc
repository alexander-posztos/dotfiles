...
imap <C-j> <Action>(EditorChooseLookupItemDown)
imap <C-k> <Action>(EditorChooseLookupItemUp)
...
let g:WhichKeyDesc_search = "<leader>se Everywhere"
...
" Close search dialog after selecting a file with <leader>sf
map <leader>sf <Action>(GotoFile)
map <leader>sc <CR> <ESC>:q<CR>
